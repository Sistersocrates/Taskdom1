/*
  ...
  1. New Tables
    - Recreated stripe_customers table with proper constraints
    - Recreated stripe_subscriptions table with proper constraints
    - Recreated stripe_orders table with proper constraints

  2. Security
    - Fixed RLS policies on all tables
    - Added proper security for views

  3. Changes
    - Dropped and recreated all tables to ensure clean state
    - Used proper view syntax compatible with Supabase
*/
