/*
  ...
  1. New Tables
    - `stripe_customers` - Stores customer information linked to users
    - `stripe_subscriptions` - Stores subscription information for customers
    - `stripe_orders` - Stores order information for one-time payments
  
  2. Views
    - `stripe_user_subscriptions` - Security definer view for user subscriptions
    - `stripe_user_orders` - Security definer view for user orders
