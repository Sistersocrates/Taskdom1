/*
  ...
  This migration creates the necessary tables and views for Stripe integration,
  with proper error handling to avoid conflicts when objects already exist.
*/

-- Create tables and policies only if they don't exist
DO $$ 
BEGIN
    ...
    -- Check if the stripe_subscriptions table exists
    ...
    -- Check if the stripe_orders table exists
