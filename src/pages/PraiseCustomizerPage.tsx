...
import { Volume2, Play, Loader2, CheckCircle, Settings, User, Users, BookOpen, Filter, Shuffle, Sliders, FileText, Plus, Trash2 } from 'lucide-react';
...
const PraiseCustomizerPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'voices' | 'scripts' | 'custom-scripts' | 'csv-scripts' | 'settings'>('voices');
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-4">
                ...
                <Button onClick={() => {
                  useVoicePraiseStore.getState().addCustomScript({
                    text: newScriptText,
              ...
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  {useVoicePraiseStore.getState().customScripts.map(script => (
                    <div key={script.id} className="p-3 bg-gray-800 rounded-lg flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Trigger: {script.trigger}</p>
                      </div>
