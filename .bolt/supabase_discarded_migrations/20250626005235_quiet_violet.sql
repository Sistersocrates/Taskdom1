/*
  # Fix Stripe Customer Policy

  1. Changes
     - Drop existing tables to avoid conflicts
     - Recreate stripe_customers table with proper RLS policies
     - Ensure users can view their own customer data
     - Fix authentication issues related to database access
*/
...
-- Set security definer for views
